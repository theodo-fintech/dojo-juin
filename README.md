...
Copiez-collez le fichier `.json` ci-dessous dans [Swagger Editor](https://editor.swagger.io/). Cela vous permettra de connaitre visualiser les différentes routes de l'API.
